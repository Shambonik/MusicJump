...
public class SettingsFragment extends Fragment implements View.OnClickListener{
    ...
    private void musicBarSettings(View v){
        audioManager = ((MainContent) Objects.requireNonNull(getActivity())).getAudioManager();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.turn_off:{
                try {
                    ((MainContent) Objects.requireNonNull(getActivity())).stopMusic();
                } catch (IOException e) {
                    e.printStackTrace();
                }
            } break;
            case R.id.turn_on: {
                ((MainContent) Objects.requireNonNull(getActivity())).startMusic();
            } break;
        }
    }
}
